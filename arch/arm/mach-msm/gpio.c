...
void msm_gpio_set_bit(unsigned n, void __iomem *reg) {
	unsigned mask = BIT(n);
	unsigned val;
...
EXPORT_SYMBOL(msm_gpio_set_bit);

void msm_gpio_clr_bit(unsigned n, void __iomem *reg) {
	unsigned mask = BIT(n);
	unsigned val;
...
EXPORT_SYMBOL(msm_gpio_clr_bit);
...
EXPORT_SYMBOL(msm_gpio_find_out);
