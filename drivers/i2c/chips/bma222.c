...
int bma222_read_accel_xyz(bma222acc_t * acc)
   ...
   if (p_bma222==C_Zero_U8X)
       ...
       * for overflow
       */
      cV = (temp32 * BMA222CAL_SCALE) /(calvalue.scalex);
      if (cV < negMaxV || cV > maxV) {
        ...
        acc->x = (temp32 * BMA222CAL_SCALE) /(calvalue.scalex);
      //[SIMT-huangli-110719]}
       ...
       * for overflow
       */
      cV = (temp32 * BMA222CAL_SCALE) /(calvalue.scaley);
      if (cV < negMaxV || cV > maxV) {
        cV = cV >> 16;
        while(cV < negMaxV || cV > maxV) {
          cV = cV >> 1;
        ...
        acc->y = (temp32 * BMA222CAL_SCALE) /(calvalue.scaley);
      //[SIMT-huangli-110719]}
