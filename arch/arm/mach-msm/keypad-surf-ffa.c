...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	...
	#define GPIO_HEADSET_KEY        67
#elif defined(CONFIG_BIGBANG)
	#define GPIO_HEADSET_KEY        43
#else
	Error! Add by Sandro!
#endif
...
static struct gpio_event_input_info headset_key_input_info = {
	...
	.flags = (GPIOEDF_ACTIVE_HIGH|GPIOEDF_PRINT_KEYS),
	.type = EV_KEY,
...
static struct gpio_event_info *headset_keypad_info[] = {
	&headset_key_input_info.info,
};

static struct gpio_event_platform_data headset_keypad_data = {
	.name		= "headset_keypad",
	.info		= headset_keypad_info,
	.info_count	= ARRAY_SIZE(headset_keypad_info)
};

struct platform_device keypad_device_headset = {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &headset_keypad_data,
	},
};
