...
#define ATMEL_CTP_NAME "atmel_sharp_ctp"

#define ATMEL_POWER_OFF		-2
#define ATMEL_POWER_ON 2
...
//[simt-zhanghui-110826]{
#define ATMELTP_IOC_MAGIC 'T'
#define ATMELTP_SET_PARA			                 _IOWR(ATMELTP_IOC_MAGIC,1, unsigned char)
//[simt-zhanghui-110826]}
