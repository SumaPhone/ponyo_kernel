...
#include "timpani_profile_7x30_ponyo.h"
...
/* [SIMT-lisensen-110825] split audio parameters for voice call and media sound. { */
static struct adie_codec_action_unit ispkr_mic_ffa_48KHz_osr256_voice[] =
    AMIC_SPKR_PRI_MONO_8000_OSR_256; /* [SIMT-lisensen-110721] 8000 profile also works for 48k */
    
static struct adie_codec_action_unit ispkr_mic_ffa_48KHz_osr256_media[] =
    AMIC_SPKR_PRI_MONO_8000_OSR_256_MEDIA; /* [SIMT-lisensen-110721] 8000 profile also works for 48k */
/* [SIMT-lisensen-110825] split audio parameters for voice call and media sound. } */
...
static struct adie_codec_hwsetting_entry ispkr_mic_ffa_settings[] = {
	{
		...
		.osr = 256,
		/* [SIMT-lisensen-110825] split audio parameters for voice call and media sound. */
        .voc = ispkr_mic_ffa_48KHz_osr256_voice,
        .voc_sz = ARRAY_SIZE(ispkr_mic_ffa_48KHz_osr256_voice),
        .media = ispkr_mic_ffa_48KHz_osr256_media,
        .media_sz = ARRAY_SIZE(ispkr_mic_ffa_48KHz_osr256_media),
	}
};
...
static struct snddev_icodec_data snddev_ihs_stereo_speaker_stereo_rx_data = {
	...
	.min_voice_rx_vol[VOC_NB_INDEX] = -2500,
	.max_voice_rx_vol[VOC_WB_INDEX] = -900,
	.min_voice_rx_vol[VOC_WB_INDEX] = -2400,
};
...
static struct adie_codec_action_unit iloop_back_actions[] =
	ADIE_LOOP_BACK;

static struct adie_codec_hwsetting_entry iloop_back_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iloop_back_actions,
		.action_sz = ARRAY_SIZE(iloop_back_actions),
	}
};

static struct adie_codec_dev_profile iloop_back_profile = {
	.path_type = ADIE_CODEC_LB,
	.settings = iloop_back_settings,
	.setting_sz = ARRAY_SIZE(iloop_back_settings),
};

static struct snddev_icodec_data snddev_loop_back_data = {
	.capability = (SNDDEV_CAP_LB),
	.name = "loop_back",
	.copp_id = 0,
	.acdb_id = ACDB_ID_LOOP_BACK,
	.profile = &iloop_back_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iloop_back_device = {
	.name = "snddev_icodec",
	.id = 22, // in every codec, the number is one and only.
	.dev = { .platform_data = &snddev_loop_back_data },
};
